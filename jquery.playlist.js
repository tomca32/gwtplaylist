...
(function( $ ){
	...
	$.fn.videoBG = function( selector, options ) { 
		...
		// define that the event name is `endVideo`
		evt.initEvent('endVideo', true, true);
	...
	$.fn.videoBG.video = function(options) {
		...
		// if meant to loop
		if ((options.loop) ||(options.loop == 0)) {
			loops_left = options.loop;
			console.log(loops_left);
			...
			console.log(loops_left);
				...
				if (loops_left !== true) {
					...
					if (loops_left <0){
					//Event dispatched after ending last play
